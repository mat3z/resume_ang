<template>
  <div id="resume2" class="resume">
    <div class="top-row">
      <span class="person-name">{{person.name.first}} {{person.name.middle}} {{person.name.last}}</span>
        ...
        <div class="education">
          ...
          >
            ...
            <div
              ...
              v-for="description in education.descriptions"
              :key="description.desc"
            >{{description.desc}}</div>
          </div>
        </div>
...
const name = 'moje-cv'; // TODO change name
